        ...
        <div class="flex flex-col bg-[#eeeeee] space-y-5 m-5 px-5 py-3 rounded-lg">
            ...
            <div class="flex flex-col lg:flex-row md:flex-row space-x-5  text-[#eeeeee] w-full justify-center ">
                <div
                    ...
                    <button @click="onSubSelect(1)"
                        class="m-4 p-2 border-1 bg-[#dddddd] text-[#06113C] rounded-lg ">Select</button>
                </div>
                <div
                    class="flex flex-col flex-wrap flex-1 shadow-md h-full  bg-[#06113C] hover:scale-105 hover:shadow-lg  transition-all ease-in-out duration-500  rounded-lg">
                    <p v-if="subscriptionChoice === 2" class="text-lg pl-8 pt-4 text-[#FF8C32]  font-semibold">6 Months ✅
                    </p>
                    ...
                    <div class="p-8">
                        <div class="flex space-x-1 ">
                            <span class="text-xs font-light">R</span>
                            <h2 class="text-3xl">50</h2><span class="flex  text-xs items-end pl-1 font-light">/per
                                month</span>
                        </div>
                        <hr class="w-48 h-1 mx-auto my-2 bg-gray-100 border-0 rounded md:my-5 dark:bg-gray-700">
                        <div>
                    ...
                    <button @click="onSubSelect(2)"
                        class="m-4 p-2 border-1 bg-[#dddddd] text-[#06113C] rounded-lg ">Select</button>
                </div>
                <div
                    class="flex flex-col flex-wrap flex-1 shadow-md h-full  bg-[#06113C] hover:scale-105 hover:shadow-lg  transition-all ease-in-out duration-500  rounded-lg">
                    <p v-if="subscriptionChoice === 3" class="text-lg pl-8 pt-4  text-[#FF8C32]  font-semibold">12 Months ✅
                    </p>
                    ...
                    <div class="p-8">
                        <div class="flex space-x-1">
                            <span class="text-xs font-light">R</span>
                            <h2 class="text-3xl">100</h2><span class="flex  text-xs items-end pl-1 font-light">/per
                                month</span>
                        </div>
                        <hr class="w-48 h-1 mx-auto my-2 bg-gray-100 border-0 rounded md:my-5 dark:bg-gray-700">
                        <div>
                    ...
                    <button @click="onSubSelect(3)"
                        class="m-4 p-2 border-1 bg-[#dddddd] text-[#06113C] rounded-lg ">Select</button>
                </div>

            </div>
   
                <button @click="checkSelection" class="w-full bg-[#FF8C32] text-[#06113c] px-3 py-2 rounded-lg ">
                    Next
                </button>
